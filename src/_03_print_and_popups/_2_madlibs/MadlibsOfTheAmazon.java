...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String advective = JOptionPane.showInputDialog("enter an adjective");
		...
		String place = JOptionPane.showInputDialog("enter any place");
		...
		JOptionPane.showMessageDialog(null,"Piranhas are more "+advective+" during the day, so cross the river at\\n\"  +\n" + 
		...
		String story = 
		"Piranhas are more "+advective+" during the day, so cross the river at\n"  +
		"night. Piranhas are attracted to fresh "+liquid+" and will most\n"  +
		"likely take a bite out of your "+bodypart+" if you "+verb+". Whatever\n"  +
		"you do, if you have an open wound, try to find another way to get\n"  +
		"back to the "+place+". Good luck!";
